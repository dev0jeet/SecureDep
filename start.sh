...
command -v semgrep     &>/dev/null && echo "      semgrep"     || echo "       semgrep missing (pip install semgrep)"
command -v bandit      &>/dev/null && echo "      bandit"      || echo "      bandit missing (pip install bandit)"
